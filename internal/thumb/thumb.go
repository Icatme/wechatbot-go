...
func FromImage(data []byte) ([]byte, error) {
	...
	if format != "jpeg" && format != "png" {
		// Decode succeeded; format is something we can resample.
	}
	thumb := scale(img)
...
var placeholderJPEG = []byte{
	...
	0x00, 0x00, 0x3f, 0x00, 0xfb, 0xd5, 0xdb, 0x20, 0xf8, 0x4b, 0xaf, 0xf8,
	0x4a, 0x3f, 0x07, 0x5f, 0xd9, 0xbe, 0x23, 0xd2, 0x7f, 0xe1, 0x3b, 0xd6,
	0x3f, 0xe1, 0x3b, 0xd6, 0x3f, 0xe1, 0x3b, 0xd6, 0x3f, 0xe1, 0x3b, 0xff,
	0xd9,
}
